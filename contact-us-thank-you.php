...
mail($to,$subject,$message,$headers);
  mail($cc,$subject,$message,$headers);
    mail($cc2,$subject,$message,$headers);
}
        ...
        <div class="contactcol2 w-clearfix w-col w-col-6">
          ...
          <div class="contactdivs">
            ...
            <div class="contactdiv w-clearfix">
              ...
              <div class="contactright">
                <p class="cinfos"><a href="mailto:ConnectTheDots2017@za.syspro.com" class="clinks">ConnectTheDots2017@za.syspro.com</a>
                </p>
              </div>
            </div>
          </div>
